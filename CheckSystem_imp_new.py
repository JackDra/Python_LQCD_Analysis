...
this_path = '/home/jackdra/LQCD/Results/HPCCRES_FixedG2/test_data/VectorTop_q01423_pp0_C2_state1_fitr9-20_t_f5.47_alpha_fitr10-20.p'
...
GE_F2_coeff.Stats()
GE_F2_coeff.Avg
# (10*GE_F2_coeff).MakeValAndErr(Dec=2)
RQ_full_list = [1,2,3]
RQ_solve_list = [1,2,3]
...
## from file: /mnt/scratch/dragosja/data/resultsFixedG2/RC32x64Kud01372700Ks01364000/FormFactors/Neutron_qmax0_ppmax4/Pickle/Vector_RFmin3_RChi50-100.p.FFstats
...
## F1, F2 no topological charge
## from file: /mnt/scratch/dragosja/data/resultsFixedG2/RC32x64Kud01372700Ks01364000/FormFactors/Proton_qmax0_ppmax4/Pickle/Vector_RFmin3_RChi50-100.p.FFstats
...
def AppendGeGm(this_ff):
    F1F2_list = this_ff[:2]
    GeGm_list = deepcopy(F1F2_list)
    GeGm_list[0] = F1F2_list[0] + GE_F2_coeff*F1F2_list[1]
    GeGm_list[1] = F1F2_list[0] + F1F2_list[1]
    GeGm_list[0].Stats()
    # gegm_list[0] = gegm_list[0].makevalanderr(dec=2)
    return np.array(list(this_ff[:2])+list(GeGm_list)+list(this_ff[2:]))
